...
const LogMessage: React.FC<MessageProps> = (props) => {
  ...
  const messageHtml = useMessageProcessor(originalMessageEl, false, allowHtmlRendering, color, imageScale, props.onRendered, replacementRules, imageAlign, imageStyle);
